...
benchmark_dir = "../../ARCH-COMP2024/benchmarks/Double_Pendulum/"
model_path = os.path.join(benchmark_dir, "controller_double_pendulum_less_robust.onnx")
input_shape = (-1, 4)
...
lirpa_model = BoundedModule(model_ori, torch.zeros(1, 4), device=device, bound_opts={'activation_bound_option': 'same-slope'})
