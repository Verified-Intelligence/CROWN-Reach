...
benchmark_dir = "../../ARCH-COMP2024/benchmarks/QUAD/"
model_path = os.path.join(benchmark_dir, "quad_controller_3_64_torch.onnx")
input_shape = (-1, 12)
...
lirpa_model = BoundedModule(model_ori, torch.zeros(1, 12), device=device, bound_opts={'activation_bound_option': 'same-slope'})
...
def CROWN_reach(input_lb, input_ub):
    ...
    lb, ub, A_dict = lirpa_model.compute_bounds(x=(bounded_tensor,), method='backward', return_A=True, needed_A_dict=required_A)
